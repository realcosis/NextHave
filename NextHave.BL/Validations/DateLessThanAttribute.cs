...
{
	public class DateLessThanAttribute(string startDatePropertyName) : ValidationAttribute
	{
		protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
		{
			...
			else
			{
				...
				return new ValidationResult(string.Format(DataAnnotationsResources.LessThan, validationContext.DisplayName, startDateDisplayName));
			}
		}
	}
}