...
{
	public class DateLessOrEqualThanAttribute(string startDatePropertyName) : ValidationAttribute
	{
		protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
		{
			...
			else
			{
				...
				return new ValidationResult(string.Format(DataAnnotationsResources.LessOrEqualThan, validationContext.DisplayName, startDateDisplayName));
			}
		}
	}
}