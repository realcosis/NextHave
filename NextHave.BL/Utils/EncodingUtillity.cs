namespace NextHave.BL.Utils
{
    ...
    {
        public static int ToInt32(this Span<byte> array, int position)
        {
        ...
        public static short ToInt16(this byte[] array,int position)
        {
        ...
        public static int ToInt32(this ReadOnlySpan<byte> array, int position)
        {
            if (position + 4 > array.Length || position < 0)
                return 0;
